...
export default function ServicesPreview() {
  const services = [
    {
      name: "Access Consciousness Bars",
      description: "Release limiting thoughts through gentle touch points",
      icon: (
    ...
    },
    {
      ...
      description: "Powerful healing sessions conducted remotely",
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Activate dormant DNA strands for optimal wellness",
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      description: "Gain clarity through intuitive readings",
      icon: (
        <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <section className="section-padding bg-gray-50">
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="heading-2 mb-6">Transformational Healing Modalities</h2>
          <p className="body-large text-gray-600">
            Experience profound healing through quantum physics-based modalities designed to 
            remove energy blocks and align your being for optimal wellness.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {services.map((service, index) => (
            <div key={index} className="card p-8 text-center hover:shadow-xl transition-all duration-300 group">
              ...
              <p className="body-text text-gray-600">{service.description}</p>
            </div>
          ))}
        </div>
